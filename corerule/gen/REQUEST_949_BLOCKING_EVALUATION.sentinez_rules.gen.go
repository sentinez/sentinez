...
func R949111() *waf.Rule {
	return &waf.Rule{
		Actions: &waf.RuleAction{
			...
			Fields:    &waf.RuleActionField{Id: []string{"949111"}, Msg: []string{"'Inbound Anomaly Score Exceeded in phase 1 (Total Score: %{TX.BLOCKING_INBOUND_ANOMALY_SCORE})'"}, Phase: []string{"1"}, Tag: []string{"'anomaly-evaluation'", "'OWASP_CRS'"}, T: []string{"none"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Logdata: []string{"'%{TX.BLOCKING_INBOUND_ANOMALY_SCORE}'"}},
		},
...
func R949110() *waf.Rule {
	return &waf.Rule{
		Actions: &waf.RuleAction{
			...
			Fields:    &waf.RuleActionField{Id: []string{"949110"}, Msg: []string{"'Inbound Anomaly Score Exceeded (Total Score: %{TX.BLOCKING_INBOUND_ANOMALY_SCORE})'"}, Phase: []string{"2"}, Tag: []string{"'anomaly-evaluation'", "'OWASP_CRS'"}, T: []string{"none"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Logdata: []string{"'%{TX.BLOCKING_INBOUND_ANOMALY_SCORE}'"}},
		},
