...
var _ grpcserver.ServiceRegistrar = (*tenant)(nil)

// NewTenant creates a new tenant service registrar.
func NewTenant(srv tenantpb.TenantServiceServer) grpcserver.ServiceRegistrar {
...
func (t *tenant) Accept(ctx context.Context, server grpcserver.Server) error {
