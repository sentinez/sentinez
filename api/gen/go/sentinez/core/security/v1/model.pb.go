...
const file_sentinez_core_security_v1_model_proto_rawDesc = "" +
	"\n" +
	"%sentinez/core/security/v1/model.proto\x12\x19sentinez.core.security.v1\x1a\x1bbuf/validate/validate.proto\x1a&sentinez/core/security/v1/shared.proto\x1a\x1dsentinez/types/v1/known.proto\x1a\x1dsentinez/types/v1/model.proto\x1a\x1fsentinez/types/v1/options.proto\"\xd8\x02\n" +
	"\tRuleBased\x127\n" +
	...
	"\x04node\x18\x05 \x01(\v2$.sentinez.core.security.v1.RuleGroupR\x04node\x12\x16\n" +
...
var (
	...
	file_sentinez_core_security_v1_model_proto_rawDescData []byte
)

func file_sentinez_core_security_v1_model_proto_rawDescGZIP() []byte {
	file_sentinez_core_security_v1_model_proto_rawDescOnce.Do(func() {
		file_sentinez_core_security_v1_model_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sentinez_core_security_v1_model_proto_rawDesc), len(file_sentinez_core_security_v1_model_proto_rawDesc)))
	})
...
var file_sentinez_core_security_v1_model_proto_depIdxs = []int32{
	...
	2, // 1: sentinez.core.security.v1.RuleBased.node:type_name -> sentinez.core.security.v1.RuleGroup
	3, // 2: sentinez.core.security.v1.RuleBased.status:type_name -> sentinez.types.v1.Status
...
func file_sentinez_core_security_v1_model_proto_init() {
	if File_sentinez_core_security_v1_model_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_sentinez_core_security_v1_model_proto_goTypes,
		DependencyIndexes: file_sentinez_core_security_v1_model_proto_depIdxs,
		MessageInfos:      file_sentinez_core_security_v1_model_proto_msgTypes,
	}.Build()
	File_sentinez_core_security_v1_model_proto = out.File
	file_sentinez_core_security_v1_model_proto_goTypes = nil
	file_sentinez_core_security_v1_model_proto_depIdxs = nil
}
