...
type Resource struct {
	...
	Status          v1.Status              `protobuf:"varint,6,opt,name=status,proto3,enum=sentinez.types.model.v1.Status" json:"status,omitempty"`
...
const file_sentinez_core_tenant_v1_model_proto_rawDesc = "" +
	"\n" +
	"#sentinez/core/tenant/v1/model.proto\x12\x17sentinez.core.tenant.v1\x1a\x1bbuf/validate/validate.proto\x1a&sentinez/types/common/v1/options.proto\x1a&sentinez/types/model/v1/metadata.proto\x1a\x1esentinez/edge/v1/setting.proto\"\xd0\x02\n" +
	"\bResource\x12=\n" +
	...
	"\x06status\x18\x06 \x01(\x0e2\x1f.sentinez.types.model.v1.StatusR\x06status:\x06\xca\xf3\x18\x02\b\x01BHZFgithub.com/sentinez/sentinez/api/gen/go/sentinez/core/tenant/v1;tenantb\x06proto3"
