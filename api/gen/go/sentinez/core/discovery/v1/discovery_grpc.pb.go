...
const (
	DiscoveryService_Register_FullMethodName  = "/sentinez.core.discovery.v1.DiscoveryService/Register"
	DiscoveryService_Heartbeat_FullMethodName = "/sentinez.core.discovery.v1.DiscoveryService/Heartbeat"
	DiscoveryService_Discover_FullMethodName  = "/sentinez.core.discovery.v1.DiscoveryService/Discover"
)
...
func (c *discoveryServiceClient) Heartbeat(ctx context.Context, in *HeartbeatRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedDiscoveryServiceServer) Heartbeat(context.Context, *HeartbeatRequest) (*emptypb.Empty, error) {
...
var DiscoveryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sentinez.core.discovery.v1.DiscoveryService",
	...
	Metadata: "sentinez/core/discovery/v1/discovery.proto",
}
