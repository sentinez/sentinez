...
const file_sentinez_types_secure_ruleevent_v1_event_proto_rawDesc = "" +
	"\n" +
	".sentinez/types/secure/ruleevent/v1/event.proto\x12\"sentinez.types.secure.ruleevent.v1\x1a.sentinez/types/secure/ruleevent/v1/types.proto\x1a\x1fsentinez/types/v1/options.proto\"\xdf\x03\n" +
	"\x05Event\x12\x19\n" +
