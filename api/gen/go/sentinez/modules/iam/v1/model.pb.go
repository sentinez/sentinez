...
func (x *Account) Reset() {
	*x = Account{}
	mi := &file_sentinez_modules_iam_v1_model_proto_msgTypes[0]
...
func (*Account) Descriptor() ([]byte, []int) {
	return file_sentinez_modules_iam_v1_model_proto_rawDescGZIP(), []int{0}
}
...
func (x *AccountResponse) Reset() {
	*x = AccountResponse{}
	mi := &file_sentinez_modules_iam_v1_model_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AccountResponse) Descriptor() ([]byte, []int) {
	return file_sentinez_modules_iam_v1_model_proto_rawDescGZIP(), []int{1}
}
...
func (x *User) Reset() {
	*x = User{}
	mi := &file_sentinez_modules_iam_v1_model_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_sentinez_modules_iam_v1_model_proto_rawDescGZIP(), []int{2}
}
...
const file_sentinez_modules_iam_v1_model_proto_rawDesc = "" +
	...
	"\fphone_number\x18\f \x01(\tB\x19\xbaH\x16r\x142\x12^\\+?[1-9]\\d{7,14}$R\vphoneNumber:\x06\xca\xf3\x18\x02\b\x01BGZEgithub.com/sentinez/sentinez/api/gen/go/sentinez/modules/iam/v1;iampbb\x06proto3"

var (
	file_sentinez_modules_iam_v1_model_proto_rawDescOnce sync.Once
	file_sentinez_modules_iam_v1_model_proto_rawDescData []byte
)

func file_sentinez_modules_iam_v1_model_proto_rawDescGZIP() []byte {
	file_sentinez_modules_iam_v1_model_proto_rawDescOnce.Do(func() {
		file_sentinez_modules_iam_v1_model_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sentinez_modules_iam_v1_model_proto_rawDesc), len(file_sentinez_modules_iam_v1_model_proto_rawDesc)))
	})
	return file_sentinez_modules_iam_v1_model_proto_rawDescData
}

var file_sentinez_modules_iam_v1_model_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_sentinez_modules_iam_v1_model_proto_goTypes = []any{
	(*Account)(nil),         // 0: sentinez.modules.iam.v1.Account
...
func file_sentinez_modules_iam_v1_model_proto_init() {
	if File_sentinez_modules_iam_v1_model_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sentinez_modules_iam_v1_model_proto_rawDesc), len(file_sentinez_modules_iam_v1_model_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sentinez_modules_iam_v1_model_proto_goTypes,
		DependencyIndexes: file_sentinez_modules_iam_v1_model_proto_depIdxs,
		MessageInfos:      file_sentinez_modules_iam_v1_model_proto_msgTypes,
	}.Build()
	File_sentinez_modules_iam_v1_model_proto = out.File
	file_sentinez_modules_iam_v1_model_proto_goTypes = nil
	file_sentinez_modules_iam_v1_model_proto_depIdxs = nil
}
