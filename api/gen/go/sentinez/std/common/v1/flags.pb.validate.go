...
// Validate checks the field values on FlagWS with the rules defined in the
// proto definition for this message. If any rules are violated, an error is returned.
func (m *FlagWS) Validate() error {
	if m == nil {
		return nil
	}
...
// FlagWSValidationError is the validation error returned by FlagWS.Validate if
// the designated constraints aren't met.
type FlagWSValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e FlagWSValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e FlagWSValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e FlagWSValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e FlagWSValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e FlagWSValidationError) ErrorName() string { return "FlagWSValidationError" }

// Error satisfies the builtin error interface
func (e FlagWSValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = FlagWSValidationError{}
