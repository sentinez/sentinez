...
export const MessageConstraints = {
    ...
    fromJSON(object) {
        return {
            ...
            cel: globalThis.Array.isArray(object?.cel) ? object.cel.map((e) => Constraint.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
export const PredefinedConstraints = {
    ...
    fromJSON(object) {
        return { cel: globalThis.Array.isArray(object?.cel) ? object.cel.map((e) => Constraint.fromJSON(e)) : [] };
    },
    toJSON(message) {
        const obj = {};
        if (message.cel?.length) {
