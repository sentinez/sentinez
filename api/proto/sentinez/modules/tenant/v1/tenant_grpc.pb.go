...
const (
	TenantService_Status_FullMethodName              = "/sentinez.modules.tenant.v1.TenantService/Status"
	TenantService_ListResource_FullMethodName        = "/sentinez.modules.tenant.v1.TenantService/ListResource"
	TenantService_CreateResource_FullMethodName      = "/sentinez.modules.tenant.v1.TenantService/CreateResource"
	TenantService_UpdateResource_FullMethodName      = "/sentinez.modules.tenant.v1.TenantService/UpdateResource"
	TenantService_DeleteResource_FullMethodName      = "/sentinez.modules.tenant.v1.TenantService/DeleteResource"
	TenantService_GetResource_FullMethodName         = "/sentinez.modules.tenant.v1.TenantService/GetResource"
	TenantService_GetResourceByDomain_FullMethodName = "/sentinez.modules.tenant.v1.TenantService/GetResourceByDomain"
)
...
type TenantServiceClient interface {
	...
	GetResourceByDomain(ctx context.Context, in *GetResourceByDomainRequest, opts ...grpc.CallOption) (*GetResourceByDomainResponse, error)
}
...
func (c *tenantServiceClient) GetResourceByDomain(ctx context.Context, in *GetResourceByDomainRequest, opts ...grpc.CallOption) (*GetResourceByDomainResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetResourceByDomainResponse)
	err := c.cc.Invoke(ctx, TenantService_GetResourceByDomain_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TenantServiceServer interface {
	...
	GetResourceByDomain(context.Context, *GetResourceByDomainRequest) (*GetResourceByDomainResponse, error)
}
...
func (UnimplementedTenantServiceServer) GetResourceByDomain(context.Context, *GetResourceByDomainRequest) (*GetResourceByDomainResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetResourceByDomain not implemented")
}
...
func _TenantService_GetResourceByDomain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetResourceByDomainRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TenantServiceServer).GetResourceByDomain(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TenantService_GetResourceByDomain_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TenantServiceServer).GetResourceByDomain(ctx, req.(*GetResourceByDomainRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TenantService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sentinez.modules.tenant.v1.TenantService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetResourceByDomain",
			Handler:    _TenantService_GetResourceByDomain_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "sentinez/modules/tenant/v1/tenant.proto",
}
