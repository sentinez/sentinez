...
func (x *Resource) Reset() {
	*x = Resource{}
	mi := &file_sentinez_modules_tenant_v1_model_proto_msgTypes[0]
...
func (*Resource) Descriptor() ([]byte, []int) {
	return file_sentinez_modules_tenant_v1_model_proto_rawDescGZIP(), []int{0}
}
...
var File_sentinez_modules_tenant_v1_model_proto protoreflect.FileDescriptor
...
const file_sentinez_modules_tenant_v1_model_proto_rawDesc = "" +
	...
	"\x04plan\x18\a \x01(\x0e2\x17.sentinez.types.v1.PlanR\x04plan:\x06\xca\xf3\x18\x02\b\x01BLZJgithub.com/sentinez/sentinez/api/proto/sentinez/modules/tenant/v1;tenantpbb\x06proto3"

var (
	file_sentinez_modules_tenant_v1_model_proto_rawDescOnce sync.Once
	file_sentinez_modules_tenant_v1_model_proto_rawDescData []byte
)

func file_sentinez_modules_tenant_v1_model_proto_rawDescGZIP() []byte {
	file_sentinez_modules_tenant_v1_model_proto_rawDescOnce.Do(func() {
		file_sentinez_modules_tenant_v1_model_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sentinez_modules_tenant_v1_model_proto_rawDesc), len(file_sentinez_modules_tenant_v1_model_proto_rawDesc)))
	})
	return file_sentinez_modules_tenant_v1_model_proto_rawDescData
}

var file_sentinez_modules_tenant_v1_model_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func init() { file_sentinez_modules_tenant_v1_model_proto_init() }
func file_sentinez_modules_tenant_v1_model_proto_init() {
	if File_sentinez_modules_tenant_v1_model_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sentinez_modules_tenant_v1_model_proto_rawDesc), len(file_sentinez_modules_tenant_v1_model_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sentinez_modules_tenant_v1_model_proto_goTypes,
		DependencyIndexes: file_sentinez_modules_tenant_v1_model_proto_depIdxs,
		MessageInfos:      file_sentinez_modules_tenant_v1_model_proto_msgTypes,
	}.Build()
	File_sentinez_modules_tenant_v1_model_proto = out.File
	file_sentinez_modules_tenant_v1_model_proto_goTypes = nil
	file_sentinez_modules_tenant_v1_model_proto_depIdxs = nil
}
