...
When asked to create a new service for a given functional domain, you must follow the standard service pattern established in the `sentinez` project (such as in `internal/core/iam/v1/service/service.go`).
