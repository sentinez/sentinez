...
var Request901InitializationOrder = []func() *rulecmn.Rule{
...
var Request901Initialization = map[string]*rulecmn.Rule{
...
func Request901InitializationMaker_0() *rulecmn.Rule {
	return &rulecmn.Rule{
...
func R901100() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901100"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.inbound_anomaly_score_threshold=5'"}},
		},
...
func R901110() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901110"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.outbound_anomaly_score_threshold=4'"}},
		},
...
func R901111() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901111"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.reporting_level=4'"}},
		},
...
func R901115() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901115"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.early_blocking=0'"}},
		},
...
func R901120() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901120"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.blocking_paranoia_level=1'"}},
		},
...
func R901125() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901125"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.detection_paranoia_level=%{TX.blocking_paranoia_level}'"}},
		},
...
func R901130() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901130"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.sampling_percentage=100'"}},
		},
...
func R901140() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901140"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.critical_anomaly_score=5'"}},
		},
...
func R901141() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901141"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.error_anomaly_score=4'"}},
		},
...
func R901142() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901142"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.warning_anomaly_score=3'"}},
		},
...
func R901143() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901143"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.notice_anomaly_score=2'"}},
		},
...
func R901160() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901160"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.allowed_methods=GET HEAD POST OPTIONS'"}},
		},
...
func R901162() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901162"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.allowed_request_content_type=|application/x-www-form-urlencoded| |multipart/form-data| |text/xml| |application/xml| |application/soap+xml| |application/json|'"}},
		},
...
func R901168() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901168"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.allowed_request_content_type_charset=|utf-8| |iso-8859-1| |iso-8859-15| |windows-1252|'"}},
		},
...
func R901163() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901163"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.allowed_http_versions=HTTP/1.0 HTTP/1.1 HTTP/2 HTTP/2.0 HTTP/3 HTTP/3.0'"}},
		},
...
func R901164() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901164"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.restricted_extensions=.ani/ .asa/ .asax/ .ascx/ .backup/ .bak/ .bat/ .cdx/ .cer/ .cfg/ .cmd/ .com/ .compositefont/ .config/ .conf/ .crt/ .cs/ .csproj/ .csr/ .dat/ .db/ .dbf/ .dist/ .dll/ .dos/ .dpkg-dist/ .drv/ .gadget/ .hta/ .htr/ .htw/ .ida/ .idc/ .idq/ .inc/ .inf/ .ini/ .jse/ .key/ .licx/ .lnk/ .log/ .mdb/ .msc/ .ocx/ .old/ .pass/ .pdb/ .pfx/ .pif/ .pem/ .pol/ .prf/ .printer/ .pwd/ .rdb/ .rdp/ .reg/ .resources/ .resx/ .scr/ .sct/ .shs/ .sql/ .swp/ .sys/ .tlb/ .tmp/ .url/ .vb/ .vbe/ .vbs/ .vbproj/ .vsdisco/ .vxd/ .webinfo/ .ws/ .wsc/ .wsf/ .wsh/ .xsd/ .xsx/'"}},
		},
...
func R901165() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901165"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.restricted_headers_basic=/content-encoding/ /proxy/ /lock-token/ /content-range/ /if/ /x-http-method-override/ /x-http-method/ /x-method-override/ /x-middleware-subrequest/'"}},
		},
...
func R901171() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901171"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.restricted_headers_extended=/accept-charset/'"}},
		},
...
func R901167() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901167"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.enforce_bodyproc_urlencoded=0'"}},
		},
...
func R901169() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901169"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.crs_validate_utf8_encoding=0'"}},
		},
...
func R901170() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901170"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.crs_skip_response_analysis=0'"}},
		},
...
func R901200() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901200"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, T: []string{"none"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.blocking_inbound_anomaly_score=0'", "'tx.detection_inbound_anomaly_score=0'", "'tx.inbound_anomaly_score_pl1=0'", "'tx.inbound_anomaly_score_pl2=0'", "'tx.inbound_anomaly_score_pl3=0'", "'tx.inbound_anomaly_score_pl4=0'", "'tx.sql_injection_score=0'", "'tx.xss_score=0'", "'tx.rfi_score=0'", "'tx.lfi_score=0'", "'tx.rce_score=0'", "'tx.php_injection_score=0'", "'tx.http_violation_score=0'", "'tx.session_fixation_score=0'", "'tx.blocking_outbound_anomaly_score=0'", "'tx.detection_outbound_anomaly_score=0'", "'tx.outbound_anomaly_score_pl1=0'", "'tx.outbound_anomaly_score_pl2=0'", "'tx.outbound_anomaly_score_pl3=0'", "'tx.outbound_anomaly_score_pl4=0'", "'tx.anomaly_score=0'"}},
		},
...
func R901320() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901320"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'tx.ua_hash=%{REQUEST_HEADERS.User-Agent}'"}},
		},
...
func R901340() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901340"}, Msg: []string{"'Enabling body inspection'"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}},
		},
...
func R901350() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901350"}, Msg: []string{"'Enabling forced body inspection for ASCII content'"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, T: []string{"none", "urlDecodeUni"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}},
		},
...
func R901400() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901400"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}},
		},
...
func R901410() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901410"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, T: []string{"sha1", "hexEncode"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}, Setvar: []string{"'TX.sampling_rnd100=%{TX.1}%{TX.2}'"}},
		},
...
func R901450() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901450"}, Msg: []string{"'Sampling: Disable the rule engine based on sampling_percentage %{TX.sampling_percentage} and random number %{TX.sampling_rnd100}'"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}},
		},
...
func Request901InitializationMaker_30() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
...
func R901500() *rulecmn.Rule {
	return &rulecmn.Rule{
		Actions: &rulecmn.RuleAction{
			...
			Fields:    &rulecmn.RuleActionField{Id: []string{"901500"}, Msg: []string{"'Detection paranoia level configured is lower than the paranoia level itself. This is illegal. Blocking request. Aborting'"}, Phase: []string{"1"}, Tag: []string{"'OWASP_CRS'"}, T: []string{"none"}, Ver: []string{"'OWASP_CRS/4.16.0-dev'"}},
		},
