...
export const Location: MessageFns<Location> = {
  encode(message: Location, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.proxySetHeaders).forEach(([key, value]: [string, string]) => {
  ...
  fromJSON(object: any): Location {
    return {
      ...
      proxyRewrite: isSet(object.proxyRewrite)
        ? globalThis.String(object.proxyRewrite)
        : isSet(object.proxy_rewrite)
        ? globalThis.String(object.proxy_rewrite)
        : "",
      proxyPass: globalThis.Array.isArray(object?.proxyPass)
        ? object.proxyPass.map((e: any) => Upstream.fromJSON(e))
        : globalThis.Array.isArray(object?.proxy_pass)
        ? object.proxy_pass.map((e: any) => Upstream.fromJSON(e))
        : [],
      balanceStrategy: isSet(object.balanceStrategy)
        ? balanceStrategyFromJSON(object.balanceStrategy)
        : isSet(object.balance_strategy)
        ? balanceStrategyFromJSON(object.balance_strategy)
        : 0,
      proxySetHeaders: isObject(object.proxySetHeaders)
        ? (globalThis.Object.entries(object.proxySetHeaders) as [string, any][]).reduce(
        ...
        : isObject(object.proxy_set_headers)
        ? (globalThis.Object.entries(object.proxy_set_headers) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: globalThis.String(value),
              enumerable: true,
  ...
  toJSON(message: Location): unknown {
    ...
    if (message.proxySetHeaders) {
      const entries = globalThis.Object.entries(message.proxySetHeaders) as [string, string][];
      if (entries.length > 0) {
        obj.proxySetHeaders = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<Location>, I>>(object: I): Location {
    ...
    message.proxySetHeaders = (globalThis.Object.entries(object.proxySetHeaders ?? {}) as [string, string][]).reduce(
