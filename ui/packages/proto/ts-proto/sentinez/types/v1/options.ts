  ...
  fromJSON(object: any): XMessage {
    return {
      databaseModel: isSet(object.databaseModel)
        ? globalThis.Boolean(object.databaseModel)
        : isSet(object.database_model)
        ? globalThis.Boolean(object.database_model)
        : false,
      exportField: isSet(object.exportField)
        ? globalThis.Boolean(object.exportField)
        : isSet(object.export_field)
        ? globalThis.Boolean(object.export_field)
        : false,
    };
  },
