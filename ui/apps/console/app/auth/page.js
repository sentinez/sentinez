...
export default function LoginPage() {
    return (<div className="grid min-h-svh lg:grid-cols-2">
      ...
      <div className="relative hidden bg-muted lg:block">
        <img src="https://placehold.co/400x600/0504aa/white?font=source-sans-pro&text=sentinéz" alt="Image" className="absolute inset-0 h-full w-full object-cover dark:brightness-[0.2] dark:grayscale"/>
      </div>
    </div>);
}
