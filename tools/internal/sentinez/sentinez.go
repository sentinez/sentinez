...
// GenerateSentinezFile generates a _sentinez.pb.go file containing gRPC service definitions.
func GenerateSentinezFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
