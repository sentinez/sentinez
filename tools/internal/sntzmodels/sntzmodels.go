...
// GenerateSntzModelsFile generates a _sntzmodels.pb.go file containing gRPC service definitions.
func GenerateSntzModelsFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	filename := file.GeneratedFilenamePrefix + "_sntzmodels.pb.go"
	g := gen.NewGeneratedFile(filename, file.GoImportPath)
	g.P("// Code generated by protoc-gen-go-sntzmodels. DO NOT EDIT.")
